...
public class RatioPagerContainer extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public RatioPagerContainer(Context context) {
        super(context);
        init();
    }

    public RatioPagerContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RatioPagerContainer(Context context, AttributeSet attrs, int defStyle) {
